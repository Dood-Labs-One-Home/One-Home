/* One Home v14.67.65 — Universal mint source attribution + dedicated X share bridge.
...
(function(){
  'use strict';
  if(window.OneHomeMintSource&&window.OneHomeMintSource.version==='14.67.66')return;

  const VERSION='14.67.66';
