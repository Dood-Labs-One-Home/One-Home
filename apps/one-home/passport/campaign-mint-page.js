...
(function(){
  ...
  const FALLBACK_EVM_NETWORKS={
    ...
    'avalanche-mainnet':{chain_key:'avalanche-mainnet',display_name:'Avalanche Mainnet (Locked)',environment:'mainnet',chain_id:43114,chain_id_hex:'0xa86a',native_symbol:'AVAX',locked:true,wallet_enabled:false,mint_enabled:false,wallet_add_chain:{rpcUrls:['https://api.avax.network/ext/bc/C/rpc'],chainId:'0xa86a',chainName:'Avalanche C-Chain',nativeCurrency:{name:'Avalanche',symbol:'AVAX',decimals:18},blockExplorerUrls:['https://snowtrace.io/']}},
